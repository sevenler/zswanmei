(function($){
	...
	$.fn.ScrollNav.openSubNav = function(opts,liThis){
		...
		$(liThis).children("ul").animate({height:heightValue-1},opts.speed);
	}
	...
	$.fn.ScrollNav.defaultValue = function(opts,liThis){
		...
		$(opts.scrollObj).stop(true,false).animate({width:widthValue-1,left:leftValue},opts.speed);
	}
})(jQuery);    
