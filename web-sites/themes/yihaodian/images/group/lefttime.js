...
function showtime()
{
  ...
  else
  {
    if (hourLeft > 0)
    {
      Temp = hourLeft + "<em>" + _hour + "</em>" + minuteZero + minuteLeft + "<em>" + _minute + "</em>" + secondZero + secondLeft + "<em>" + _second + "</em>";
    }
    else
    {
      if (minuteLeft > 0)
      {
        Temp = minuteLeft + "<em>" + _minute + "</em>" + secondZero + secondLeft + "<em>" + _second + "</em>";
      }
      else
      {
        if (secondLeft > 0)
        {
          Temp = secondLeft + "<em>" +  _second + "</em>";
        }
        else
        {
          Temp = '';
